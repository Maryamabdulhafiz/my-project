...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="dashoard.php" class="nav-link">Home</a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="dashoard3.php" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="dashoard.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="diagnosis.php" class="nav-link">
                ...
                <div class="card card-danger">
                  ...
                  <?php 
                    if (isset($_POST['submit'])) {
                      $r = $user->getFuzzy($_POST['an'],$_POST['n'],$_POST['d'],$_POST['f'],$_POST['j'],$_POST['w'],$_POST['e'],$_POST['h'],$_POST['v'],$_POST['jp'],$_POST['la']);
                      echo '
                        <div class="card-header">
                          <h3 class="card-title">Result: </h3>
                          <h3 class="card-title text-right"> Malaria Level = '.$user->getResult($r->result ?? $r).'</h3>
                      </div>
                        <table class="table table-bordered">
                          <tr>
                            <th>Anemia:</th><td>'.$user->getResult($_POST['an']).'</td><th>Nausea:</th><td>'.$user->getResult($_POST['n']).'</td>
                          </tr>
                          <tr>
                          <th>Dizziness:</th><td>'.$user->getResult($_POST['d']).'</td><th>Fever:</th><td>'.$user->getResult($_POST['f']).'</td>
                        </tr>
                         <tr>
                                <th>Jaundice:</th><td>'.$user->getResult($_POST['j']).'</td><th>Body weakness:</th><td>'.$user->getResult($_POST['w']).'</td>
                        </tr> 
                              <tr>
                              <th>Enlarge liver:</th><td>'.$user->getResult($_POST['e']).'</td><th>Headache:</th><td>'.$user->getResult($_POST['h']).'</td>
                        </tr>
                            <tr>
                            <th>Vomitting:</th><td>'.$user->getResult($_POST['v']).'</td><th>Join Pain:</th><td>'.$user->getResult($_POST['jp']).'</td>
                        </tr> 
                        <tr>
                            <th>Loss of Appatite:</th><td>'.$user->getResult($_POST['la']).'</td><th></th><td></td>
                        </tr>
                        <tr>
                            <th class"float-right text-right" style="text-align:right;">Prescription:</th><td colspan="3">'.trim($r->prescription ?? "").'</td>
                        </tr>
