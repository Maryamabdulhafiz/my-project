                    ...
                    if (isset($_POST['submit'])) {
                      echo '
                        <div class="card-header">
                          ...
                          <h3 class="card-title text-right"> Malaria Level = '.$user->getFuzzy($_POST['an'],$_POST['n'],$_POST['d'],$_POST['f'],$_POST['j'],$_POST['w'],$_POST['e'],$_POST['h'],$_POST['v'],$_POST['jp'],$_POST['la']).'</h3>
                      </div>
                      ...
                      echo '
                      <form action="admin_diagnosis.php" method="POST">
