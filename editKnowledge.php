                ...
                <div class="card card-default">
                  ...
                  <?php 
                    ...
                    if (isset($_POST['submit'])) {
                      $r = $user->updateKnowledge($_POST['id'],$_POST['an'],$_POST['n'],$_POST['d'],$_POST['f'],$_POST['j'],$_POST['w'],$_POST['e'],$_POST['h'],$_POST['v'],$_POST['jp'],$_POST['la'],$_POST['result'],$_POST['prescription'] );
                      if ($r ==1) {
                        echo '
                          <div class="alert alert-success">Knowledge succesfully updated.</div>
                        ';
                      }
                    ...
                    //  echo $knowledgeArray;
                      echo '
                      <form action="editKnowledge.php" method="POST">
                      <div class="card-body row">
                        ...
                        <div class="form-group">
                              ...
                              <textarea name="prescription" class="form-control col-lg-12" cols="118">'.trim($knowledgeArray['prescription'] ?? "").'
                              </textarea>
                        </div>
                      </div>
                      <!-- /.card-body -->
